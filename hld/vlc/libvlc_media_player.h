...
//sskim20090923
VLC_PUBLIC_API float libvlc_media_player_get_input_bitrate( libvlc_media_player_t *, libvlc_exception_t *);
VLC_PUBLIC_API int libvlc_media_player_get_program_info(libvlc_media_player_t *, libvlc_exception_t *, int*);
VLC_PUBLIC_API int libvlc_media_player_set_current_program(libvlc_media_player_t *, libvlc_exception_t *, int);
//sskim20100111
VLC_PUBLIC_API void libvlc_video_move_resize( libvlc_media_player_t *, int, int, int, int, libvlc_exception_t *p_e);
VLC_PUBLIC_API void libvlc_video_show_window( libvlc_media_player_t *, int, libvlc_exception_t *p_e );
VLC_PUBLIC_API int libvlc_video_is_window_visible( libvlc_media_player_t *, libvlc_exception_t *p_e );
//sskim20100113
VLC_PUBLIC_API void libvlc_video_destroy_window( libvlc_media_player_t *p_mi, libvlc_exception_t *p_e );
